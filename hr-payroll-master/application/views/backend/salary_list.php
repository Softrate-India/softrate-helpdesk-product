        ...
        buttons: [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '50pt' )
                        .prepend(
                            '<img src="<?php echo base_url()?>assets/images/softrate-logo-watermark.png" style="position:absolute;background-size:300px 300px; top:35%; left:27%;" />'
                        );
                    $(win.document.body)
                        //.css( 'border', 'inherit' )
                        .prepend(
                    ...
                    $(win.document.body).find( 'div' )
                        ...
                        .css( 'height', '100px' )
                        .prepend(
                            '<img src="<?php echo base_url()?>assets/images/softrate-making-ideas-happen.png" style="position:absolute;background-size:30%; top:0; left:0;" />'
                        );
