...
<head>
    ...
    <title>Softrate Help Desk</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/softrate-helpdesk-home.svg);">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/logo-icon.png" alt="softrate India" /></a>
